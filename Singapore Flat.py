...
st.set_page_config(page_title='HDB Flat Resale Price Predictor',page_icon='house',initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'The streamlit application was developed by Vanmathi R'})
...
if selected == "Get Prediction":
    st.write('')
    st.markdown("<h5 style=color:red>To Predict the Resale Price of a Flat, Please Provide the Following Information:",unsafe_allow_html=True)
    st.write('')
